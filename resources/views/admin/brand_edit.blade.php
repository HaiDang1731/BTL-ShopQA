...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.update', ['id' => $brand->id]) }}"
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div id="upload-file" class="item up-load">
                                <label class="uploadfile" for="myFile">
                                    ...
                                    <span class="body-text">Nhấn để chọn ảnh Brands <span class="tf-color">click to
                                            browse</span></span>
                    ...
                    <div class="bot">
                        <div></div>
                        <button class="tf-button w208" type="submit">Lưu Ảnh</button>
                    </div>
                </form>
